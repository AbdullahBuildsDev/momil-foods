      ...
      <div className="site-container grid grid-cols-1 gap-12 md:grid-cols-[1.5fr_1fr_1.2fr] md:gap-16 lg:gap-24 items-start" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
        ...
        <div>
          ...
          <div className="mt-6 flex flex-col gap-2">
            <a href="mailto:momilfoods@gmail.com" className="text-sm text-white/75 hover:text-[#F5C518] transition-colors">
              momilfoods@gmail.com
            </a>
            <a href="https://wa.me/923452211111" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-white/75 hover:text-[#F5C518] transition-colors">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-sm font-black uppercase tracking-[0.22em] text-[#F5C518] mb-6">Quick Links</h4>
          <nav className="flex flex-col">
            {[['/', 'Home'], ['/about', 'About'], ['/products', 'Products'], ['/blog', 'Blog'], ['/contact', 'Contact']].map(([href, label]) => (
              <Link key={href} href={href}
                className="py-2.5 text-sm text-white/60 hover:text-[#F5C518] border-b border-white/8 transition-colors">
                {label}
              </Link>
            ))}
          </nav>
        ...
        {/* Contact Info */}
        <div>
          <h4 className="text-sm font-black uppercase tracking-[0.22em] text-[#F5C518] mb-6">Contact Info</h4>
          <div className="flex flex-col gap-5 text-sm text-white/60 leading-7">
            <div>
              <p className="text-white/35 text-[10px] uppercase tracking-widest font-bold mb-1">Email</p>
              <a href="mailto:momilfoods@gmail.com" className="hover:text-[#F5C518] transition-colors">momilfoods@gmail.com</a>
            </div>
            <div>
              <p className="text-white/35 text-[10px] uppercase tracking-widest font-bold mb-1">Phone / WhatsApp</p>
            ...
            <div>
              <p className="text-white/35 text-[10px] uppercase tracking-widest font-bold mb-1">Services</p>
              <p>Private Labeling · Bulk Supplying</p>
              <p>Co-Packing · USA-FDA Registration</p>
            </div>
            <div>
              <p className="text-white/35 text-[10px] uppercase tracking-widest font-bold mb-1">Export Markets</p>

  ...
  return (
    <main>
      ...
      <div className="pt-32 pb-16 bg-gradient-to-br from-[#102006] via-[#2D5016] to-[#D97706] text-white text-center">
        <h1 className="text-5xl md:text-6xl font-black drop-shadow-xl">About Momil Foods</h1>
      ...
      <section className="max-w-5xl mx-auto px-8 py-16 grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="mt-8 p-6 bg-gradient-to-br from-[#FDE68A] to-[#F5C518] rounded-lg">

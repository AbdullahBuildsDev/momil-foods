  ...
  return (
    <main>
      ...
      <div className="pt-32 pb-16 bg-gradient-to-br from-[#102006] via-[#2D5016] to-[#D97706] text-white text-center">
        <h1 className="text-5xl md:text-6xl font-black drop-shadow-xl">Our Products</h1>
      </div>
              ...
              return (
                <Link key={p.id} href={`/products/${cat?.slug || p.category}/${p.slug}`}
                  ...
                  {p.image
                    ...
                    : <div className="h-48 bg-gradient-to-br from-[#F5C518] via-[#FDE68A] to-[#D97706] flex items-center justify-center text-6xl">{cat?.emoji || '🌿'}</div>
                  }
                  <div className="p-4">
